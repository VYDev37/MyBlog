                ...
                <form method="POST" action="{{ route('post.update', compact('post')) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-textarea id="content" class="block mt-1 w-full" type="content" name="content"
                            :value="$post->content" required autofocus />
                    ...
                    <div class="mt-4" x-data="{ previewUrl: '{{ $post->image ? $post->imageUrl() : '' }}' }">
                        ...
                        <template x-if="previewUrl">
                            <div
                                class="mt-2 mb-4 relative w-full sm:w-1/2 md:w-1/3 aspect-video bg-gray-100 rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                    ...
                    <div class="mt-4">
                        ...
                        <select id="category_id" name="category_id" :value="$post->category_id"
